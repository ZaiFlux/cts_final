...
due_date.grid(row=0, column=1, sticky="nsew")  # center by expanding

# ===== Three-dot button with menu =====
...
# Make middle column expand to center the due date
